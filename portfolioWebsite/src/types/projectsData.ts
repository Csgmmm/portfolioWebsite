...
export const projects: IProjectData[] = [
  ...
  //bmw
  {
    ...
    chips: ["FIGMA", "photoshop", "illustrator"],
    fullDescription:
      "I created this concept to demonstrate my ability to redesign a complex existing ecosystem. My focus was on elevating the My BMW app and iDrive System through a more cohesive, premium, and seamless user experience between the mobile device and the vehicle dashboard. The details I focused on: High-Density Data Management: Designed the iDrive Dashboard Display to balance critical driving information—like speed and ePower levels—with secondary content like GPS navigation and music playback without cluttering the view. Design System: Developed a full library of components, including cards for vehicle status, high-contrast input fields, and badges. Scalable Layouts: Used variables for spacing to guarantee the design is organized and adapts perfectly to different screen aspect ratios. Data Clarity: Reimagined the iDrive Dashboard to balance critical driving data with music and navigation without cluttering the driver's view.",
    images: ["/assets/code1.png", "/assets/code2.png", "/assets/code3.png"],
  },
  //bmw
  {
    ...
    chips: ["FIGMA", "photoshop", "illustrator"],
    fullDescription:
      "I designed this concept to explore the future of Automotive HMI (Human Machine Interface), specifically focusing on the Mercedes A-Class. This UI Project highlights safety-critical environment and modernize it with a user-centric interface that prioritizes driver focus and personalization. And I focused on: - Dynamic Visual Identity: Reimagined the classic dashboard with a futuristic, high-contrast aesthetic. Including a personalized 'Display Color Change' feature to match the driver's preference or ambient lighting. - Intuitive Media & Connectivity: Designed a streamlined music and profile interface that balances rich album art with clear, accessible playback controls.",
    images: ["/assets/code1.png", "/assets/code2.png", "/assets/code3.png"],
  },
  //montepio
  {
    ...
    chips: ["FIGMA", "photoshop", "illustrator"],
    fullDescription:
      "This project is a UI/UX redesign of the mobile application for Banco Montepio, one of Portugal's financial institutions. The challenge was to transform a traditional banking identity into a vibrant, mobile-first experience that appeals to a younger demographic without alienating long-time users. -Human-Centric Onboarding: The login screens move away from sterile forms, using lifestyle imagery and intuitive biometric triggers (FaceID/TouchID) - Intuitive Account Management: Users can swipe through different account types (Current vs. Savings) using a familiar carousel pattern. -Visual Spending Insights: A dedicated expenses hub featuring interactive bar charts and color-coded categories like Food and public transports. - Digital Piggy Bank:  Integrated features to encourage micro-savings and goal-oriented financial planning.",
    images: ["/assets/code1.png", "/assets/code2.png", "/assets/code3.png"],
  },
];
